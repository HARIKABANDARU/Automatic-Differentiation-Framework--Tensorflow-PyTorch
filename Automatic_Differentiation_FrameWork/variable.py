...
class Variable(object):
    ...
    def derivative(self, v):
        ...
        if self == v:# and (self.d_op == d_neg or self.d_op == None):
            if self.d_op == d_neg:
                return -1
            else:
                return 1
        ...
        #print(self.d_op(self.operands,v))
    ...
    def __truediv__(self, other):
        ...
        """
        #print(other)
        #python 3 does true division by '/' operator
        if other == 0:
            raise(Exception("Division by zero"))
            return None
        return Variable(value = self.value/promote(other).value,
                        d_op = d_truediv,
                        operands = [self,promote(other)])
